...
def retrieve_for_case(
    ...
    def build_short_term() -> str:
        st_memory = ShortTermMemory(strategy="sliding", max_recent_messages=6, pressure_tokens=450)
    ...
    else:  # mixed (or unknown) -> combine per case["retrieve_layers"]
